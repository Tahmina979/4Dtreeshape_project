...
function [G,qCompTree_3Ls1p, qCompTree_3Ls2] = ReparamPerm_qCompTrees_rad_3layers_v2_within(qCompTree_3Ls1, qCompTree_3Ls2, lam_m,lam_s,lam_p)


% Pad minor trees
[qCompTree_3Ls1, qCompTree_3Ls2] = CompatMax_rad_3layers_within(qCompTree_3Ls1, qCompTree_3Ls2);
...
if K1~=K2
Etotal = 100000000000; %lam_m* Emain + Efin+1000000000;
G = struct('E',Etotal, 'gam0',[0], 'matched',[0]);
qCompTree_3Ls1p=qCompTree_3Ls1;
qCompTree_3Ls2=qCompTree_3Ls2;
return;
end
...
for i=1:K1
    for j=1:K2
        ...
        [G, ~] = ReparamPerm_qST_rad_v2_within(qCompTree_3Ls1.q_children{i}, qCompTree_3Ls2.q_children{j}, lam_m,lam_s,lam_p);
        Eside = sqrt(G.E);
...
for i = 1: numel(qCompTree_3Ls1p.q_children)
    ...
    % --- 
   [G1, qCompTree_3Ls1p.q_children{i}, qCompTree_3Ls2.q_children{i}] = ReparamPerm_qST_rad_v2_within(qCompTree_3Ls1p.q_children{i}, qCompTree_3Ls2.q_children{i},lam_m,lam_s,lam_p);
   % if qCompTree_3Ls1p.q_children{i}.K_sideNum==qCompTree_3Ls2.q_children{i}.K_sideNum
    % Reset 
