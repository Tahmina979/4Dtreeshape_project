...
function [G,qST1p, qST2] = ReparamPerm_qST_rad_v2_within(qST1,qST2, lam_m,lam_s,lam_p)
% function [matched,Etotal,E] = ReparamPerm_qST(qST1,qST2, lam_m,lam_s,lam_p)

% pad trees
[qST1, qST2] = CompatMax_rad_within(qST1, qST2);
...
if K1~=K2
Etotal =10000000; %lam_m*Emain + Efin+1000000000000;
G = struct('E',Etotal, 'gam0',[0], 'gam',{[0]}, ...
    'matched',[0]);
qST1p=qST1;
qST2=qST2;
return;
