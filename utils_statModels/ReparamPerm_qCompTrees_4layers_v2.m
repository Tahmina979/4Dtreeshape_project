...
function [G,qCompTree_4Ls1p, qCompTree_4Ls2] = ReparamPerm_qCompTrees_4layers_v2(qCompTree_4Ls1,qCompTree_4Ls2, lam_m,lam_s,lam_p)
...
%         [gam_side_all{i,j}, Eside0] = DPQ_difflen(qCompTree_4Ls1.q{i}, qCompTree_4Ls2.q{j});
        [G, ~] = ReparamPerm_qCompTrees_3layers_v2(qCompTree_4Ls1.q_children{i}, ...
...
%     qCompTree_4Ls1p.q{matched(i,2)} = GammaActionQ(qCompTree_4Ls1.q{matched(i,1)}, G.gam{i});
...
for i = 1: numel(qCompTree_4Ls1p.q_children)
    ...
    % --- here it is better that numel(qCompTree_4Ls1p.q_children{i}.q) is less than
    % numel(qCompTree_4Ls2_p.q_children{i}.q) .
    [~, qCompTree_4Ls1p.q_children{i}, qCompTree_4Ls2.q_children{i}] = ...
                            ReparamPerm_qCompTrees_3layers_v2(qCompTree_4Ls1p.q_children{i}, qCompTree_4Ls2.q_children{i}, ...
                                                              lam_m,lam_s,lam_p);
