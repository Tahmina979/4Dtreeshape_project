function [A, qA] = GeodComplexTreesPrespace_rad_3layers(Q1, Q2, geo_param, start_origin, weights)
...
[~,qA] = GeodSimpleTreesPrespace_rad(Q1, Q2, geo_param, start_origin, weights); 
for i=1: numel(qA)
...
for i=1: numel(Q1.q_children)
    [~, qA_children] = GeodSimpleTreesPrespace_rad(Q1.q_children{i}, Q2.q_children{i}, geo_param, start_origin, weights);
