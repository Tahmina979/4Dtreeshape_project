function show_all_shapes_modes_tomato(CT,count)

addpath Yanirk_code

% remove all continue statement when deal with whole tree
...
for i=1:numel(CT)
   ...
   %100 gap for modes and 150 for rand samples
   if count==1
      z_added=0;
   end
   if count==2
