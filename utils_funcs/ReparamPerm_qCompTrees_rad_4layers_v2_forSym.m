...
function [G,qCompTree_4Ls1p, qCompTree_4Ls2] = ReparamPerm_qCompTrees_rad_4layers_v2_forSym(qCompTree_4Ls1,qCompTree_4Ls2, lam_m,lam_s,lam_p)
...
qCompTree_4Ls1p.s = qCompTree_4Ls1p.s + ...
                    linspace(0, 1e-5, length(qCompTree_4Ls1p.s)); % prevent Q.s to be zero vector
...
for i = 1: numel(qCompTree_4Ls1p.q_children)
    ...
    [~, qCompTree_4Ls1p.q_children{i}, qCompTree_4Ls2.q_children{i}] = ...
                            ReparamPerm_qCompTrees_rad_3layers_v2_forSym(qCompTree_4Ls1p.q_children{i}, qCompTree_4Ls2.q_children{i}, ...
                                                                        lam_m,lam_s,lam_p);
