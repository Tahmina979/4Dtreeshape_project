function [Q1p,Q2p] = CompatMax_3layers(Q1, Q2)
...
if Q1.K_sideNum<K
    for k=Km+1:K
        q_children_ST2{k} = Q2.q_children{k};
        q_children_ST1{k} = makeZeroST(q_children_ST2{k});
    end
elseif Q2.K_sideNum<K
    for k=Km+1:K
        q_children_ST1{k} = Q1.q_children{k};
        q_children_ST2{k} = makeZeroST(q_children_ST1{k});
    end
end

% make return values
Q1p = make_qCompTree_3layers(q0_1, q_children_ST1, sk_1, Q1.b00_startP);
Q2p = make_qCompTree_3layers(q0_2, q_children_ST2, sk_2, Q2.b00_startP);
