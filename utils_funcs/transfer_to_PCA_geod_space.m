function [Mu,eigenVector, EVals,tree_pca,used_qCompTrees_Ready,qX]=transfer_to_PCA_geod_space(aligned_q_tree_1,aligned_q_tree_2,num_within_seq1,num_within_seq2)
lam_m = 1; 
lam_s = 1;
lam_p = 1;
