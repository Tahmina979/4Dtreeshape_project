...
X=zeros(mode_length,size(tree_pca,2),num_within_seq1); % 69 is the dimention of PCA space

for i=1:mode_length
X(i,:,:)=reshape(qX_PC1{i},[size(tree_pca,2),num_within_seq1]);
end
...
show_all_shapes_modes_tomato(PC,md);
