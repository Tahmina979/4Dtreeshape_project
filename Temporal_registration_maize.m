...
ctree_1 = load('seq1_alligned.mat');
...
show_all_shapes_reg_maize(all_compTrees1,1);

data_path2= 'utils_data/maize03_seq_alt/';
[all_qCompTrees2, all_compTrees2] = maize_load_from_mat_file(data_path2);
num_within_seq2=numel(all_compTrees2);
show_all_shapes_reg_maize(all_compTrees2,2);
...
show_all_shapes_reg_maize(PC,3);
...
show_all_shapes_reg_maize(PC2,4);

%Ground truth target

data_path1= 'utils_data/maize03_seq/';
[all_qCompTrees1, all_compTrees1] = maize_load_from_mat_file(data_path1);
num_within_seq1=numel(all_compTrees1);
show_all_shapes_reg_maize(all_compTrees1,5);